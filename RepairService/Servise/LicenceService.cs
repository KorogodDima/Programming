  ...
  <Exponent>AQAB</Exponent>
        ...
        public class LicenceValidator
        {
            public LicenceValidator()
            {
                ...
                foreach (var file in Directory.EnumerateFiles(cd, "*.s_licence"))
                {
...

            {
                ...
                rsaKey.FromXmlString(LicenceService.PublicKey);
                ...
                service = (LicenceService)new XmlSerializer(typeof(LicenceService)).Deserialize(fileStream);
