...
namespace RepairService.UI
{
    ...
    {
        public RepairRequest rr { get; set; }
        public Form1()
        {
            InitializeComponent();
            ButtonSmartphone.CheckedChanged += new EventHandler(radioButtons_CheckedChanged);
            ButtonTablet.CheckedChanged += new EventHandler(radioButtons_CheckedChanged);
            ButtonLaptop.CheckedChanged += new EventHandler(radioButtons_CheckedChanged);
            ButtonPC.CheckedChanged += new EventHandler(radioButtons_CheckedChanged);
        }
